...
export function CollectionForm({ page, brand }: { page: PageData; brand: BrandData }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Branded header */}
      <header style={{ backgroundColor: brandColor }} className="px-4 py-5 text-white text-center shrink-0">
      ...
      <div className="flex-1 px-4 py-6 w-full max-w-lg mx-auto space-y-6">
        ...
        {step === 'choose' && (
          <div className="space-y-3">
            <button
              ...
              className="w-full border-2 rounded-2xl py-4 font-semibold text-base flex items-center justify-center gap-2 transition-opacity active:opacity-70"
            >
              <span>🎥</span> Record a quick video
            </button>
            <button
              onClick={() => { setTestimonialType('text'); setStep('write') }}
              className="w-full border-2 border-gray-200 rounded-2xl py-4 font-semibold text-base text-gray-700 flex items-center justify-center gap-2 transition-opacity active:opacity-70"
            >
        ...
        {step === 'record' && (
          <div className="space-y-3">
            ...
            />
            <button onClick={() => setStep('choose')} className="text-sm text-gray-400 underline w-full text-center">
              Back
            </button>
          </div>
        )}
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl text-white font-semibold disabled:bg-gray-200 disabled:text-gray-400"
              >
                Next
              </button>
            </div>
        ...
        {step === 'details' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-200 text-sm text-gray-600 disabled:opacity-50 transition-opacity active:opacity-70"
                >
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
              <label className="flex gap-3 items-start cursor-pointer">
                ...
                <span className="text-sm text-gray-600 leading-snug">
                  I allow{' '}
                  <strong className="text-gray-800">{brand.brand_name ?? 'this business'}</strong>{' '}
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-white font-semibold text-base disabled:bg-gray-200 disabled:text-gray-400 transition-opacity active:opacity-80"
            >
