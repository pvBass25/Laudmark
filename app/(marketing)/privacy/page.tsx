...
export default function PrivacyPage() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-sm text-muted leading-relaxed">
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">What we collect</h2>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Third-party processors</h2>
        ...
        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Cookies</h2>
          <p>We use only a session cookie required for authentication. We do not use tracking or advertising cookies.</p>
        </section>

        <section>
          <h2 className="font-semibold text-ink text-base mb-2">Your rights (GDPR)</h2>
        ...
        <section>
          ...
          <p>Questions? Email us at <a href="mailto:privacy@trustwall.app" className="text-brand hover:underline">privacy@trustwall.app</a></p>
        </section>
      </div>
    </main>
  )
