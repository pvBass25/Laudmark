  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">1. Acceptance</h2>
          <p>By using Trustwall you agree to these terms. If you do not agree, do not use the service.</p>
        </section>

        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">2. Service</h2>
        ...
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">3. Your responsibilities</h2>
        ...
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">4. AI-generated content</h2>
        ...
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">5. Billing</h2>
        ...
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">6. Limitation of liability</h2>
        ...
        <section>
          <h2 className="font-semibold text-gray-900 text-base mb-2">7. Termination</h2>
