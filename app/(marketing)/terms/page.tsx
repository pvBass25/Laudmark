    ...
    <main className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="space-y-6 text-sm text-muted leading-relaxed">
        <section>
          ...
          <p>By using LaudMark you agree to these terms. If you do not agree, do not use the service.</p>
        </section>

        <section>
          <h2 className="font-semibold text-ink text-base mb-2">2. Service</h2>
          <p>LaudMark provides tools for collecting, managing, and displaying customer testimonials. We reserve the right to modify or discontinue the service with reasonable notice.</p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>You may not use LaudMark to publish fabricated, incentivised (without disclosure), or deceptive reviews. This is a violation of FTC guidelines and these terms.</li>
        ...
        <section>
          ...
          <p>LaudMark uses AI to clean and summarise testimonial text. Our system is designed with anti-fabrication rules: the AI may not add praise, facts, or sentiment not present in the original. You remain responsible for reviewing and approving published content.</p>
        </section>
        ...
        <section>
          ...
          <p>LaudMark is provided "as is". We are not liable for indirect, incidental, or consequential damages. Our total liability is limited to the fees paid in the last 3 months.</p>
        </section>
